...
screen.rowconfigure(1,weight=3)
screen.rowconfigure(2,weight=1)
screen.rowconfigure(3,weight=3)
screen.rowconfigure(4,weight=1)
screen.rowconfigure(5,weight=1)


screen.columnconfigure(0,weight=3)  #somehow, si on met les poids à 1 partout ils sont pas tous égaux
...
barre_recherche.grid(row = 0, column= 1,columnspan=2,padx= 250,sticky=EW)
...
img_viande = PhotoImage(file="./images/viande.png")
...
img_poisson = PhotoImage(file="./images/poisson.png")
